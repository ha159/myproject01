<template>
    <div id="address">
    	<div class="address_edit">
			...
			<div style="display: none" class="single_line border_top addres">
				<span class="t_span">设置为默认地址</span>
        ...
        methods:{
            sendAddr(){
            	...
            	if(_this.ship_name==''||_this.ship_mb==''||_this.ship_address==''){
            		...
            		axios.post('/api/cart/addAddress',{
            	...
            	.then(function (res) {
				    ...
				    Toast({
                	   ...
                	   _this.$router.push({path:"/confirmOrder"});
